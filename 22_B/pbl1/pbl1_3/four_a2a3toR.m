function [Rm,theta_m] = four_a2a3toR(rp,fp,rn,fn,a2p,a2n)
...
% 初始猜测值
initialGuess = [100, 40]; % 根据问题的具体情况调整

% 使用 fsolve 求解
options = optimoptions('fsolve', 'Algorithm', 'trust-region-dogleg', 'Display', 'iter'); % 显示迭代过程
